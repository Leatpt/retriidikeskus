<div class="{{ $showModal ? 'block' : 'hidden' }}">
    <div class="fixed z-50 inset-0">
        <div class="flex justify-center items-center min-h-screen px-4">
            ...
            <div class="z-50 w-full items-start max-h-[95vh] max-w-3xl bg-white rounded-lg shadow-lg p-6 overflow-y-auto" wire:click.stop>
                            ...
                            <div class="mt-8 grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-8">
                                <div class="sm:col-span-3">
                                    <x-form-field>
                                        ...
                                        <button type="button"
                                            class="mt-2 text-sm text-emerald-600 cursor-pointer hover:text-emerald-700"
                                            wire:click="addDate">
                                            + Lisa kuupäev
                                        </button>
                                    </x-form-field>
