            ...
            <div class="z-50 w-full max-w-3xl bg-white rounded-lg shadow-lg p-6" wire:click.stop>
                <form method="POST" action="/events" class="w-full">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-8">
                                <div class="sm:col-span-6">
                                    <x-form-field>
                                        ...
                                        <div class="mt-2">
                                            <x-form-input name="title" id="title" placeholder="Retriit" type="text" required />
                            ...
                            <div class="mt-8 grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-8">
                                <div class="sm:col-span-6">
                                    <x-form-field>
                                        ...
                                        <div class="mt-2">
                                            <x-form-input name="description" id="description" type="textarea" />
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <button type="button" class="text-sm font-semibold leading-6 text-gray-900">Tühista</button>
                        <x-form-button>Salvesta</x-form-button>
                    </div>
                </form>
            </div>
        </div>
